...
### V6.3 (2026-05-13)
- **新增线稿海报 / PPT 页面工作流**：吸收小小东 2026-05-11 新提示词，强调“先检索后作图”、信息可靠性、参考图转译与页面化表达
- **补入可复用示例**：新增 `examples/card-xiaoxiaodong-line-poster.md`，支持知识型海报、封面、PPT 页面和信息页生成
- **视觉模式继续工程化**：把单纯风格生成升级为“检索 → 内容组织 → 视觉表达 → 页面输出”的完整编译任务
...
> 🔴 Lyra V6.3 就绪。支持高质感卡片模式、槽位化 TaskSpec、YouMind 风格模板库、视觉 DNA 提取、3秒读懂原则，以及线稿海报 / PPT 页面工作流。
> 请提供需求，可选附带 `[模式标签]`。
